# `feature_triple_tilde.jl`

**Proves:** `#~~~` = depth 3 (tilde-count), with a depth-3 block nesting in a depth-2 chapter
...
Committed pair: `examples/InFileFolder/feature_triple_tilde.jl` → `examples/OutFileFolder/feature_triple_tilde.jl` — the same
